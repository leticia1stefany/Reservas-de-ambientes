...
import com.reservasDeAmbientes.Entity.BaseEntity;
import com.reservasDeAmbientes.Repository.BaseRepository;
...
public abstract class BaseService<E extends BaseEntity, D>{
    ...
    public E toEntity(D dto) {
        try {
            ...
            throw new RuntimeException("Erro ao converter de DTO para Entidade", ex);
        }
    }
